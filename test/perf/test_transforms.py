...
# ~10 KB of epoch seconds / ISO 8601 dates, one per line
_UNIX_TEXT = "\n".join(str(1752710400 + i) for i in range(900))
_DATE_TEXT = "\n".join(f"2025-07-17T00:{i // 60:02d}:{i % 60:02d}+00:00" for i in range(400))
...
_SPECIAL_INPUTS: dict[str, str] = {
    ...
    "unix-to-date": _UNIX_TEXT,
    "date-to-unix": _DATE_TEXT,
}
